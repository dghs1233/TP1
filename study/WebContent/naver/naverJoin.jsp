...
<script type="text/javascript">
	...
	function sendIt() {
		...
		//alert(f.userId.value + " 회원가입 성공!!");

		f.action = "<%=cp %>/naver/naverJoin_ok.jsp";
		f.submit();
	}
...
<table width="450px" align="center">
	<tr>
		<td align="left">
		<a href="https://www.naver.com"><img src="<%=cp %>/html/image/naver_icon.gif"/></a>
		</td>
	</tr>
</table>
...
<tr height="48">
	<td colspan="2" valign="middle"><img src="<%=cp %>/html/image/naver_id.gif" align="middle"/>
		<input type="text" name="userId" placeholder="아이디" style="background-color: #11ffee00; 
			width: 60%; height: 50%; align: middle; color: #ffffff;"/>@naver.com
	</td>
</tr>

<tr height="48">
	<td colspan="2" valign="middle"><img src="<%=cp %>/html/image/naver_pw.gif" align="middle"/>
		<input type="password" name="pwd" placeholder="비밀번호" style="background-color: #11ffee00; 
			width: 60%; height: 50%; align: middle; color: #ffffff;" >
	</td>
</tr>

<tr height="48">
	<td colspan="2" valign="middle"><img src="<%=cp %>/html/image/naver_email.gif" align="middle"/>
...
<tr height="48">
	<td colspan="2" valign="middle"><img src="<%=cp %>/html/image/naver_birth.gif" align="middle"/>
...
<tr height="48">
	<td colspan="2" valign="middle"><img src="<%=cp %>/html/image/naver_telecom.gif" align="middle"/>
...
<tr height="48">
	<td valign="middle" align="center">
		...
		<font color="#ffffff">남자</font>
		<input type="radio" name="sex" value="F">
		<font color="#ffffff">여자</font>
		
		<input type="radio" name="foreigner" value="K"
			style="background-color: #777;">
		<font color="#ffffff">내국인</font>
		<input type="radio" name="foreigner" value="Fo">
		<font color="#ffffff">외국인</font>
	</td>
</tr>

<tr height="48">
	<td colspan="2" valign="middle"><img src="<%=cp %>/html/image/naver_phone.gif" align="middle"/>
...
<tr>
	<td width="55%" valign="bottom" align="center">
		<a href="javascript: sendIt();"><img src="<%=cp %>/html/image/naver_verify.gif"/ width="500px"></a>
	</td>
</tr>
