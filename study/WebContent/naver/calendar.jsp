...
<!-- 테이블 가운데 정렬 -->
<table align="center" width="400px" cellpadding="2" cellspacing="1">
<tr>
	<!-- 열의 글자 가운데 정렬 -->
	<td align="center">
	
	<a href="login.jsp?year=<%=nowYear %>&month=<%=nowMonth %>"><img src="../jsp2/image/today.jpg" align="left"></a>
	<a href="../jsp2/calendar.jsp?year=<%=nowYear %>&month=<%=nowMonth %>"><font color="#aa3366">원본페이지</font></a>
	
	<!-- 위에 있는 변수값 가져와야함 -->
	<a href="login.jsp?year=<%=preYear %>&month=<%=preMonth %>"><font color="#aa66ff">◀</font></a>
	...
	<a href="login.jsp?year=<%=nextYear %>&month=<%=nextMonth %>"><font color="#aa66ff">▶</font></a>
	</td>
</tr>	
</table>

<table align="center" width="400" cellpadding="0" cellspacing="1"
bgcolor="#cccccc">
<tr>
